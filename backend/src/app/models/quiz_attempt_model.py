...
if TYPE_CHECKING:
    ...
    # Avoid circular imports at runtime
    from app.models.quiz_feedback_model import QuizFeedback, QuizQuestionFeedback
    # Avoid circular imports at runtime
    from app.models.quiz_grade_model import QuizGrade
    # Avoid circular imports at runtime
...
class QuizAttemptBase(SQLModel):
    ...
    quiz_feedback_id: UUID | None = Field(
        default=None, foreign_key="QuizFeedback.id")
...
class QuizAttempt(BaseUUIDModel, QuizAttemptBase, table=True):
    ...
    quiz_grades: list["QuizGrade"] = Relationship(
        back_populates="quiz_attempt")
    quiz_feedback: Optional["QuizFeedback"] = Relationship(
...
class QuizAnswerSlot(BaseUUIDModel, QuizAnswerSlotBase, table=True):
    ...
    quiz_question_feedback_id: UUID | None = Field(
        default=None, foreign_key="QuizQuestionFeedback.id")
    ...
    quiz_question_feedback: Optional["QuizQuestionFeedback"] = Relationship(
        back_populates="quiz_answer_slots")
    selected_options: list["QuizAnswerOption"] = Relationship(
...
class QuizAnswerOption(BaseUUIDModel, QuizAnswerOptionBase, table=True):
    ...
    quiz_answer_slot: "QuizAnswerSlot" = Relationship(
