...
Revision ID: abd304978f4e
Revises: 
Create Date: 2024-02-21 03:05:22.504335
...
def upgrade():
    ...
    sa.Column('default_grade', sa.Integer(), nullable=False),
    sa.Column('difficulty', sa.Enum('easy', 'medium', 'hard', name='questiondifficultyenum'), nullable=False),
    sa.Column('question_type', sa.Enum('single_select_mcq', 'multi_select_mcq', 'open_text_question', 'coding_question', name='questiontypeenum'), nullable=False),
    ...
    sa.Column('quiz_id', sqlmodel.sql.sqltypes.GUID(), nullable=False),
    sa.Column('time_limit', sa.Interval(), nullable=False),
    sa.Column('time_started', sa.Interval(), nullable=True),
    sa.Column('time_finish', sa.Interval(), nullable=True),
    sa.Column('total_points', sa.Integer(), nullable=False),
    sa.Column('attempt_score', sa.Integer(), nullable=True),
