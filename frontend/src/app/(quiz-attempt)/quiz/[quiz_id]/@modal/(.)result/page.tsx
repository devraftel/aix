...
const page = async ({ params, searchParams }: Props) => {
  ...
  let attempt_score_str = parseFloat(attempt_score ?? "0");
  let total_points_str = parseFloat(total_points ?? "0");
  ...
  return (
    <Dialog defaultOpen={true}>
      <DialogContent className="max-w-2xl bg-aix-100 border border-aix-200">
        <MaxWidthWrapper className="mb-20 sm:mb-36 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center h-[40vh]">
          <div className=" rounded-3xl drop-shadow-md backdrop-blur-md w-full py-[5rem] px-[7rem] flex flex-col items-center justify-center space-y-4">
